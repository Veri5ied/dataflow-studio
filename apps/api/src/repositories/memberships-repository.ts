...
export async function findMembership(executor: DbExecutor, workspaceId: string, userId: string) {
...
export async function countActiveWorkspaceSeats(executor: DbExecutor, workspaceId: string) {
