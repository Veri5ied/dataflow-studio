...
export const demoDbs = {
  ecommerce: {
    ...
    tables: {
      ...
      orders: {
        rows: 38291,
        cols: ['id', 'user_id', 'status', 'total_cents', 'created_at', 'shipped_at'],
      },
      products: {
        rows: 1204,
  ...
  analytics: {
    ...
    tables: {
      events: {
        rows: 482091,
        cols: ['id', 'session_id', 'user_id', 'name', 'properties', 'timestamp'],
      },
      sessions: {
        rows: 28310,
        cols: ['id', 'user_id', 'device', 'browser', 'country', 'started_at', 'ended_at'],
      },
      pageviews: {
        rows: 194820,
        cols: ['id', 'session_id', 'url', 'referrer', 'duration_ms', 'timestamp'],
      },
      goals: {
        rows: 9204,
  ...
  saas: {
    ...
    tables: {
      ...
      subscriptions: {
        rows: 298,
        cols: ['id', 'workspace_id', 'plan', 'status', 'seats', 'current_period_end'],
      },
      invoices: {
        rows: 1840,
        cols: ['id', 'workspace_id', 'amount_cents', 'status', 'due_at', 'paid_at'],
      },
      usage_events: {
        rows: 94820,
...
export const mockResults: Record<string, QueryResult> = {
  'SELECT * FROM users LIMIT 10;': {
    ...
    rows: [
      ...
      ['usr_002', 'kofi@example.com', 'Kofi Mensah', 'GH', 'silver', '2025-11-14'],
      ['usr_003', 'fatima@example.com', 'Fatima Diallo', 'SN', 'bronze', '2025-12-01'],
      ['usr_004', 'zainab@example.com', 'Zainab Musa', 'NG', 'gold', '2025-12-18'],
      ['usr_005', 'emeka@example.com', 'Emeka Obi', 'NG', 'silver', '2026-01-03'],
      ['usr_006', 'amara@example.com', 'Amara Toure', 'CI', 'bronze', '2026-01-20'],
      ['usr_007', 'kwame@example.com', 'Kwame Asante', 'GH', 'gold', '2026-02-05'],
      ['usr_008', 'nadia@example.com', 'Nadia Benali', 'MA', 'bronze', '2026-02-18'],
      ['usr_009', 'seun@example.com', 'Seun Adeyemi', 'NG', 'silver', '2026-03-01'],
      ['usr_010', 'lily@example.com', 'Lily Osei', 'GH', 'bronze', '2026-03-04'],
    ],
  },
  ...
  'SELECT * FROM events LIMIT 10;': {
    ...
    rows: [
      ...
      ['evt_008', 'ses_a4', 'usr_002', 'checkout_complete', '2026-03-05 08:05:12'],
...
export const aiQueries: Record<DemoDatabaseKey, { sql: string; result: QueryResult }> = {
  ecommerce: {
...
const sampleValues = {
  email: ['ada@ex.com', 'kofi@ex.com', 'fatima@ex.com', 'zainab@ex.com', 'kwame@ex.com'],
  name: ['Ada Okonkwo', 'Kofi Mensah', 'Fatima Diallo', 'Zainab Musa', 'Kwame Asante'],
